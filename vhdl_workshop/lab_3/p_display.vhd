...
package p_display is
  ...
  subtype TDigits is integer range 0 to 10;

  subtype TDisplay is std_ulogic_vector(6 downto 0);

  constant c_SEG_0 : std_ulogic_vector(6 downto 0) := "0111111";
  constant c_SEG_1 : std_ulogic_vector(6 downto 0) := "0000011";
  constant c_SEG_2 : std_ulogic_vector(6 downto 0) := "1101101";
  constant c_SEG_3 : std_ulogic_vector(6 downto 0) := "1100111";
  constant c_SEG_4 : std_ulogic_vector(6 downto 0) := "1010011";
  constant c_SEG_5 : std_ulogic_vector(6 downto 0) := "1110110";
  constant c_SEG_6 : std_ulogic_vector(6 downto 0) := "1111110";
  constant c_SEG_7 : std_ulogic_vector(6 downto 0) := "0100011";
  constant c_SEG_8 : std_ulogic_vector(6 downto 0) := "1111111";
  constant c_SEG_9 : std_ulogic_vector(6 downto 0) := "1110111";
  constant c_SEG_E : std_ulogic_vector(6 downto 0) := "1111100";
...
package body p_display is
  ...
  constant c_ACTIVE_SEG : character := '#';
  constant c_EMPTY_SEG  : character := ' ';
  ...
  subtype tmatrixrow is bit_vector (1 to WIDTH);
    ...
    for segment in 0 to 6 loop
      if (display(segment) = '1') then
        ...
        for row in TSegDef'range loop
          disp_matrix(ROW)(TDigitRow'range) := DISP_MATRIX(ROW)(TDigitRow'range) or
